        ...
        try {
            ...
            for (FieldInfo field : tableInfo.getFieldList()) {
                ...
                if (ArrayUtils.contains(Constants.SQL_DATE_TIME_TYPE, field.getSqlType())) {
                    bw.write("\t" + String.format(Constants.BEAN_DATE_SERIALIZE_EXPRESSION, DateUtils.YYYY_MM_DD_HH_MM_SS));
                    bw.newLine();

                    bw.write("\t" + String.format(Constants.BEAN_DATE_UNSERIALIZE_EXPRESSION, DateUtils.YYYY_MM_DD_HH_MM_SS));
                    bw.newLine();
                }


                if (ArrayUtils.contains(Constants.SQL_DATE_TYPE, field.getSqlType())) {
                    bw.write("\t" + String.format(Constants.BEAN_DATE_SERIALIZE_EXPRESSION, DateUtils.YYYY_MM_DD));
                    bw.newLine();

                    bw.write("\t" + String.format(Constants.BEAN_DATE_UNSERIALIZE_EXPRESSION, DateUtils.YYYY_MM_DD));
                    bw.newLine();
            ...
            for (FieldInfo field : tableInfo.getFieldList()) {
                ...
                toString.append(field.getComment() + ":\" + (" + propertyName + " == null ? \"空\" : " + propertyName + ")");
