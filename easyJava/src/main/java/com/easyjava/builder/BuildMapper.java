    ...
    public static void execute(TableInfo tableInfo) {
        ...
        try {
            ...
            for (Map.Entry<String, List<FieldInfo>> entry : keyINdexMap.entrySet()) {
                ...
                bw.write("\tT selectBy" + methodNmae + "(" + methodParams + ");");
                bw.newLine();
                bw.newLine();

                BuildComment.createFieldComment(bw, "根据" + methodNmae + "更新");
                bw.write("\tInteger updateBy" + methodNmae + "(@Param(\"bean\") T t, " + methodParams + ");");
                bw.newLine();
                bw.newLine();

                BuildComment.createFieldComment(bw, "根据" + methodNmae + "删除");
                bw.write("\tInteger deleteBy" + methodNmae + "(" + methodParams + ");");
                bw.newLine();
                bw.newLine();
            }
